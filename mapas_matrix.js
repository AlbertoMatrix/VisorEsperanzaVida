...
var div = L.DomUtil.create('div', 'info2');
	 div.innerHTML +=
	 'VISOR CARTOGRÁFICO<h3>Esperanza de vida de las personas mayores en España';
	 return div;
	};
	title2.addTo(map);
//Logo Matrix	
...
onEachFeature: function (feature, layer) {
        layer.bindTooltip(feature.properties.Contour.toLocaleString().replace(".",","),{permanent: true, opacity: 1, direction: 'center',});
    }
});	
...
var baseTree = [
	...
	children: [
		...
		{ label: "Edad de defunción media de hombres mayores de edad avanzadaa",layer: mapa5},
...
var htmlLegend1 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de la esperanza de vida de la población de mayores. Periodo 2007-2018'+"<\h2>",
			style: style1,
			layer: geojson1,
			elements: [{


				label:"<h3>"+  '<br>Edad de defunción media de la población de personas mayores <br>(≥ 65 años) <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
	...
	var htmlLegend2 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de la esperanza de vida de la población de hombres mayores. Periodo 2007-2018'+"<\h2>",
			style: style2,
			layer: geojson2,
			elements: [{


				label:"<h3>"+  '<br>Edad de defunción media de la población de hombres mayores <br>(≥ 65 años) <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
		        label:"<h3>"+  '<br>Unidades : años'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:'<img src="images/leyenda.jpg",></img><br>',
	...
	// leyenda 65M
		...
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de la esperanza de vida de la población de mujeres mayores. Periodo 2007-2018'+"<\h2>",
			style: style3,
			layer: geojson3,
			elements: [{


				label:"<h3>"+  'Edad de defunción media de la población de mujeres mayores <br>(≥ 65 años) <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
		        label:"<h3>"+  '<br>Unidades : años'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:'<img src="images/leyenda.jpg",></img><br>',
	...
	// leyenda 80T
		...
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de la esperanza de vida de la población de personas de edad avanzada. <br>Periodo 2007-2018'+"<\h2>",
			style: style4,
			layer: geojson4,
			elements: [{


				label:"<h3>"+  'Edad de defunción media de la población de personas mayores <br>de edad avanzada (≥ 80 años). <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
		        label:"<h3>"+  '<br>Unidades : años'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
	...
	var htmlLegend5 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de la esperanza de vida de la población de hombres mayores de edad avanzada. Periodo 2007-2018'+"<\h2>",
			style: style5,
			layer: geojson5,
			elements: [{


				label:"<h3>"+  'Edad de defunción media de la población de hombres mayores <br>de edad avanzada (≥ 80 años). <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
		        label:"<h3>"+  '<br>Unidades : años'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:'<img src="images/leyenda80.jpg",></img><br>',
	...
	var htmlLegend6 = L.control.htmllegend({
		position: 'bottomleft',
		legends: [{
			name: "<h2>"+ 'Modelo espacial de la esperanza de vida de la población de mujeres mayores de edad avanzada. Periodo 2007-2018'+"<\h2>",
			style: style6,
			layer: geojson6,
			elements: [{


				label:"<h3>"+  'Edad de defunción media de la población de mujeres mayores de edad avanzada (≥ 80 años). <br>'+"<\h3>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
		        label:"<h3>"+  '<br>Unidades : años'+"<\h4>",html: '',style: {'background-color': 'write','width': '0px','height': '0px'}}, {
				label:'<img src="images/leyenda80.jpg",></img><br>',
